...
export default function Home() {
  ...
  const people = [
    ...
    },
    {
      ...
      image: "/images/arman_profile_photo-removebg-preview.png",
    },
    {
      id: 2,
      name: "mr.Sabir Y.K.",
      designation: "Founder",
      image: "/images/sabir_bhai_profile_photo-removebg.png",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="w-full items-center justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        ...
        />
        <Spotlight
          className="md:hidden top-2 left-2 bottom-80  "
          fill="darkblue"
        />
        <div className="p-4 mx-auto flex flex-col items-center justify-center relative z-10 w-full pt-10 md:pt-20 px-2 min-h-[640px]">
          <div className="text-4xl pb-5 md:text-6xl px-6 text-center  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to bg-neutral-400 bg-opacity-50">
            <Cover>CODE SWIPES 🚀</Cover>
          </div>

          <div className="text-2xl pb-5 md:text-5xl px-6 text-center  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to bg-neutral-400 bg-opacity-50">
        ...
        <text>
          <div className="text-center text-lg text-neutral-300 pt-10">
            <p className="text-lg text-neutral-300">
              Copyright &copy; Code Swipes. 2024 All Rights Reserved
            </p>
          </div>
          <br />
        </text>
